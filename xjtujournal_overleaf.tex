%==============================================================================
% 西安交通大学学报 LaTeX 模板 - Overleaf 优化版
% XJTU Journal LaTeX Template - Optimized for Overleaf
%
% 重要：在 Overleaf 中请将编译器设置为 XeLaTeX
...
% 宏包加载
%------------------------------------------------------------------------------
\usepackage[UTF8,fontset=ubuntu]{ctex}  % 使用ubuntu字体集，Overleaf兼容性更好
\usepackage{times}
\usepackage{setspace}
\usepackage{geometry}
\usepackage{multicol}
...
\newcommand{\xiaosihao}{\fontsize{14pt}{\baselineskip}\selectfont}  % 四号用于标题
\newcommand{\wuhao}{\fontsize{10.5pt}{\baselineskip}\selectfont}
\newcommand{\xiaowuhao}{\fontsize{9pt}{\baselineskip}\selectfont}
\newcommand{\liuhao}{\fontsize{7.5pt}{\baselineskip}\selectfont}

%------------------------------------------------------------------------------
% 字体样式定义（使用ctex的字体切换命令）
%------------------------------------------------------------------------------
% 注意：Overleaf使用Fandol字体，样式可能略有不同，但符合要求

% 字体家族快捷命令
\newcommand{\songti}{\CJKfamily{fandol}}  % 使用fandol的宋体风格
\newcommand{\heiti}{\CJKfamily{fandolhei}}  % 黑体
\newcommand{\kaishu}{\CJKfamily{fandol}}  % 楷体用宋体代替（fandol没有单独楷体）
\newcommand{\fangsong}{\CJKfamily{fandol}}

% 加粗快捷命令（确保黑体效果明显）
\newcommand{\bfheiti}{\bfseries\heiti}
\newcommand{\bfsongti}{\bfseries\songti}
...
% 一级标题：四号宋体居中
\titleformat{\section}
    {\xiaosihao\songti\centering\bfseries}
    {\thesection}
    {0pt}
    {}
...
%===【中文摘要和关键词】=======================================================
\noindent{\wuhao\heiti\bfseries 摘要}{\wuhao\songti
...
\noindent{\wuhao\heiti\bfseries 关键词：}{\wuhao\songti
压力旋流喷嘴；空化流动；喷雾特性；锥度系数；可视化试验}

\vspace{0.3cm}

\noindent{\wuhao\heiti\bfseries 中图分类号：}{\wuhao\songti
TK423}

\vspace{0.2cm}

\noindent{\wuhao\heiti\bfseries 文献标志码：}{\wuhao\songti
A}
