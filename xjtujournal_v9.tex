%==============================================================================
% 西安交通大学学报 LaTeX 模板 - v8.0版
% XJTU Journal LaTeX Template - v8.0 Version
%
% 编译器:XeLaTeX
% Menu -> Compiler -> XeLaTeX
%
% 修正内容:
%   1. 调整首页页眉左右栏,使第二行与中间栏英文同一行
%   2. 使用\\[5pt]和\\[-23pt]实现行对齐
%   3. 作者信息与学校信息间距调整为5磅
%   4. 论文题目置于页眉和作者信息中间位置
%   5. 参考文献改为双栏排版
%   6. 参考文献人名不加粗
...
\begin{center}
    ...
    \textrm{\textbf{Effects of the Taper Coefficient on the Internal Flow and Spray}}\\
    \textrm{\textbf{Characteristics of a Pressure-Swirl Nozzle}}
\end{center}
...
\begin{tabular}{cccc}
\toprule
工况 & 压力/\textrm{MPa} & 流量/(\textrm{L·min}\textsuperscript{-1}) & 雷诺数 \\
\midrule
1 & 0.5 & 2.3 & 5000 \\
2 & 1.0 & 3.2 & 10000 \\
3 & 1.5 & 3.9 & 15000 \\
...
\bibitem{ref1}
\textrm{SOM S K, AGGARWAL M L. Spray behavior and air entrainment in plain-orifice sprays[J]. Physics of Fluids, 1991, 3(12): 2955-2964.}

\bibitem{ref2}
\textrm{KIM J Y, LEE S Y. Dependence of spraying performance on the internal flow pattern in pressure-swirl atomizers[J]. Atomization and Sprays, 2001, 11(6): 615-632.}
...
\bibitem{ref5}
\textrm{ZHANG W, NIU H, ZHANG X. Experimental investigation on the cavitation flow inside a pressure-swirl nozzle[J]. Experimental Thermal and Fluid Science, 2020, 118: 110188.}
