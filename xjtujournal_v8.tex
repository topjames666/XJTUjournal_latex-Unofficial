...
\fancyhead[CE]{\wuhao\songti 西\hspace{4pt}安\hspace{4pt}交\hspace{4pt}通\hspace{4pt}大\hspace{4pt}学\hspace{4pt}学\hspace{4pt}报}
\fancyfoot[C]{\wuhao\songti \thepage}
...
\begin{center}
    ...
    \textbf{Effects of the Taper Coefficient on the Internal Flow and Spray}\\
    \textbf{Characteristics of a Pressure-Swirl Nozzle}
\end{center}
