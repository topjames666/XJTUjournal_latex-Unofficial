%==============================================================================
% 西安交通大学学报 LaTeX 模板 - v10.0版
% XJTU Journal LaTeX Template - v10.0 Version
%
% 编译器:XeLaTeX
% Menu -> Compiler -> XeLaTeX
%
% 修正内容:
%   1. 使用 newtxtext,newtxmath 宏包提供更粗的英文字体
%   2. ctex 使用 fontset=fandol 确保中文字体正常
%   3. 移除 amsmath,amssymb（newtxmath 已包含）
%   4. 英文标题使用 \bfseries 实现加粗效果
%==============================================================================
