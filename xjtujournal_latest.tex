...
\begin{table}[H]
\centering
\wuhao\kaishu 表1 试验工况参数\\
\xiaowuhao\textrm Tab.1 Test Conditions Parameters}
...
\xiaowuhao\songti 图1 喷嘴内部空化流动形态\\
\xiaowuhao\textrm Fig.1 Cavitation Flow Pattern Inside Nozzle}
...
\centering
\rule{0.4\columnwidth}{2.5cm}
\xiaowuhao\songti 图2 喷雾锥角随锥度系数的变化\\
\xiaowuhao\textrm Fig.2 Variation of Spray Cone Angle with Taper Coefficient}
...
\begin{table}[H]
\centering
\wuhao\kaishu 表2 不同工况下喷雾锥角测量结果\\
\xiaowuhao\textrm Tab.2 Measurement Results of Spray Cone Angle under Different Conditions}
