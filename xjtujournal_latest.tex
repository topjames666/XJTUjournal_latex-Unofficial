...
\DeclareCaptionFont{xiaowuhaotimes}{\xiaowuhao\textrm}

% 图题:小5号宋体(中文), 小5号Times New Roman(英文)
% 格式: 中文图名在上，英文图名在下，居中对齐
\captionsetup[figure]{
...
% 表题:中文5号楷体, 英文小5号Times New Roman
% 格式: 中文表名在上，英文表名在下，居中对齐
\captionsetup[table]{
    font=wuhaokaishu,
...
\begin{table}[H]
\centering
\caption{\wuhao\kaishu 表1 试验工况参数\\\xiaowuhao\textrm Tab.1 Test Conditions Parameters}
...
\caption{\xiaowuhao\songti 图1 喷嘴内部空化流动形态\\\xiaowuhao\textrm Fig.1 Cavitation Flow Pattern Inside Nozzle}
...
\centering
\rule{0.4\columnwidth}{2.5cm}
\caption{\xiaowuhao\songti 图2 喷雾锥角随锥度系数的变化\\\xiaowuhao\textrm Fig.2 Variation of Spray Cone Angle with Taper Coefficient}
...
\begin{table}[H]
\centering
\caption{\wuhao\kaishu 表2 不同工况下喷雾锥角测量结果\\\xiaowuhao\textrm Tab.2 Measurement Results of Spray Cone Angle under Different Conditions}
